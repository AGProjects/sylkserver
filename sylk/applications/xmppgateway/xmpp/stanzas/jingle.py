...
NS_JINGLE_APPS_RTP = NS_JINGLE_BASE + ':apps:rtp:1'
NS_JINGLE_APPS_RTP_INFO = NS_JINGLE_BASE + ':apps:rtp:info:1'
NS_JINGLE_APPS_RTP_AUDIO = NS_JINGLE_BASE + ':apps:rtp:audio'
NS_JINGLE_APPS_RTP_VIDEO = NS_JINGLE_BASE + ':apps:rtp:video'
